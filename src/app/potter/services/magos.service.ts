...
export class HarryPotterService {
  ...
  private getSpellImage(name: string): string {
    ...
    const images: { [key: string]: string } = {
      ...
      "Piertotum Locomotor": 'assets/images/imgOpt/piertotumlocomotor.jpg',
      "Protean Charm": 'assets/images/imgOpt/proteancharm.webp',
      "Protego": 'assets/images/imgOpt/protego.jpg',
      "Reducio": 'assets/images/imgOpt/reducto.jpg',
      "Renneverate":'assets/images/imgOpt/rennervate.jpg',
      "Reparifors":'assets/images/imgOpt/reparifors.webp',
      "Reparo":'assets/images/imgOpt/reparo.jpg',
      "Rictusempra":'assets/images/imgOpt/rictussempra.jpg',
      "Riddikulus":'assets/images/imgOpt/riddiculus.jpg',
      "Scourgify":'assets/images/imgOpt/scourgify.webp',
      "Sectumsempra":'assets/images/imgOpt/sectumsempra.jpg',
      "Serpensortia":'assets/images/imgOpt/serpersortia.jpg',
      "Silencio":'assets/images/imgOpt/silencio.jpg',
      "Sonorus":'assets/images/imgOpt/sonorus.webp',
      "Spongify":'assets/images/imgOpt/sponfigy.webp',
      "Stupefy":'assets/images/imgOpt/stupefy.jpg',
      "Tarantallegra":'assets/images/imgOpt/tarantallegra.jpg',
      "Ubreakable Vow":'assets/images/imgOpt/ubreakablevow.webp',
      "Wingardium Leviosa":'/assets/images/imgOpt/wingardiumleviosa.jpg',
